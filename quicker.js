...
/* Generated by Opal 0.6.0 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2, grid = nil;

  $opal.add_stubs(['$attr_reader', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$>=', '$context', '$+', '$*', '$-', '$page_x', '$page_y', '$[]', '$Document', '$scrollLeft', '$documentElement', '$scrollTop', '$body', '$new', '$on', '$get_cursor_position', '$x', '$y', '$fill_cell', '$find', '$draw_canvas', '$add_mouse_event_listener']);
  ;
  ;
  ;
  (function($base, $super) {
    ...
    $opal.cdecl($scope, 'CELL_HEIGHT', 50);

    $opal.cdecl($scope, 'CELL_WIDTH', 100);
    ...
    def.$get_cursor_position = function(event) {
      ...
      x = (x['$/']((($a = $scope.CELL_WIDTH) == null ? $opal.cm('CELL_WIDTH') : $a))).$floor();
      y = (y['$/']((($a = $scope.CELL_HEIGHT) == null ? $opal.cm('CELL_HEIGHT') : $a))).$floor();
      return (($a = $scope.Coordinates) == null ? $opal.cm('Coordinates') : $a).$new($hash2(["x", "y"], {"x": x, "y": y}));
    };

    return (def.$add_mouse_event_listener = function() {
      var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, $e, TMP_4, $f, self = this, isDragged = nil, chosenY = nil;

      isDragged = false;
      chosenY = 0;
      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find("#" + (self.$canvas_id()))).$on, $a._p = (TMP_1 = function(event){var self = TMP_1._s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
        chosenY = y;
        self.$fill_cell(x, chosenY);
        return isDragged = true;}, TMP_1._s = self, TMP_1), $a).call($b, "mousedown");
      ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find("#" + (self.$canvas_id()))).$on, $a._p = (TMP_2 = function(event){var self = TMP_2._s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      if (isDragged !== false && isDragged !== nil) {
          coords = self.$get_cursor_position(event);
          $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
          return self.$fill_cell(x, chosenY);
          } else {
          return nil
...
if (event == null) event = nil;
      return isDragged = false}, TMP_3._s = self, TMP_3), $a).call($d, "mouseout");
      return ($a = ($e = (($f = $scope.Element) == null ? $opal.cm('Element') : $f).$find("#" + (self.$canvas_id()))).$on, $a._p = (TMP_4 = function(event){var self = TMP_4._s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      if (isDragged !== false && isDragged !== nil) {
          coords = self.$get_cursor_position(event);
          $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
          ...
          return nil
        }}, TMP_4._s = self, TMP_4), $a).call($e, "mouseup");
    }, nil);
  })(self, null);
  (function($base, $super) {
    ...
    return nil;
  })(self, (($a = $scope.OpenStruct) == null ? $opal.cm('OpenStruct') : $a));
  grid = (($a = $scope.Grid) == null ? $opal.cm('Grid') : $a).$new();
  grid.$draw_canvas();
  return grid.$add_mouse_event_listener();
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/quicker.js.map
;
